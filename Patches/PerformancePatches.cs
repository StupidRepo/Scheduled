...
public class PerformancePatches
{
    ...
    public class UnitySh_t
    {
        ...
        {
            return !Plugin.Config.ImprovePerformance.Value; // stop spamming the console with warnings
        }
        ...
        {
            return !Plugin.Config.ImprovePerformance.Value; // stop spamming the console with errors
        }
